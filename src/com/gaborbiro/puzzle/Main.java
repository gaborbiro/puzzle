...
public class Main {
    ...
    private static final Offset puzzlePrinter = Printer.offset(Contants.PRINT_ROW_OFFSET, 0);
    private static final Offset indexPrinter = puzzlePrinter.offset(10, 0);
    private static final Offset printer = indexPrinter.offset(1, 0, 2);
    ...
    private static class PuzzleFilter implements Callback {
        ...
        public String toString(List<Point> path) {
            ...
            return buffer.length() > 1 ? buffer.substring(0, buffer.length() - 2) : buffer.toString();
        }
